...
for file in files:
	...
	# compression
	command = "python333 src/lzma/compress.py" + "  " +  os.path.join(path,file) + " " + os.path.join('processing', file+"_compressed")
	os.system(command)
	...
	command = "python333 src/lzma/decompress.py" + "  " +  os.path.join('processing', file+"_compressed") + " " + os.path.join('processing', file+"_compressed_decompressed")
	os.system(command)
