...
while True:
    ...
    try:
        ...
        os.system("aws s3 cp s3://s3-worm/slave1/status data/status")        
    ...
    if status == 'START':
        ...
        os.system("aws s3 sync s3://s3-worm/slave1/ data/ --delete")
        ...
        try:
           ...
           # print('settings status to stop')
            ...
            os.system("aws s3 sync data/ s3://s3-worm/slave1/ --delete")
